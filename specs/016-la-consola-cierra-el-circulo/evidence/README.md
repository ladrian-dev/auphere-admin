...
|---|---|---|---|
| CE-001 | Conectar WhatsApp desde la consola deja al cliente listo | `test_signup_activates_a_provisioning_client_with_a_published_agent`; `whatsapp-connect.test.tsx`; **número real conectado en staging** ([us1-whatsapp-staging.md](us1-whatsapp-staging.md)), tras dos arreglos de cabeceras (bug `meta-no-devuelve-el-codigo`) | ✅ |
