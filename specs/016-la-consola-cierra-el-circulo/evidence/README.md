...
|---|---|---|---|
| CE-001 | Conectar WhatsApp desde la consola deja al cliente listo | `test_signup_activates_a_provisioning_client_with_a_published_agent`; `whatsapp-connect.test.tsx`; recorrido en staging pendiente ([us1-whatsapp-staging.md](us1-whatsapp-staging.md)) | **parcial: falta staging** |
...
| CE-003 | Mover cupo es atómico | `test_move_allocation_is_atomic`, `test_move_allocation_lowers_and_raises_in_one_call` | ✅ |
