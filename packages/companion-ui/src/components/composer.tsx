...
type Props = {
  ...
  onStop: () => void;
  /**
   * Cambiar el modo del hilo. **Opcional desde la spec 003**: en la
   * aplicación de escritorio el modo lo fija el teammate y no hay nada que
   * cambiar, así que sin este manejador el selector **no se pinta** — un
   * control que no hace nada es una pantalla que miente (§V).
   */
