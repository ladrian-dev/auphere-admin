...
#
#     Para refrescar un secreto que YA existe —una rotación de Aurora, que
#     ocurre cada 7 días— usa **refresh_app_secret.sh**: parte de lo que
#     hay, reescribe sólo las URLs de base de datos y comprueba contra las
#     definiciones de tarea que no falta ninguna clave.
