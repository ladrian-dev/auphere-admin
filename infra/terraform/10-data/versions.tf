...
variable "state_bucket" {
  description = "Bucket del estado remoto (el de backend.hcl) — para terraform_remote_state."
  type        = string
}
...
locals {
  ...
  # precondition del cluster Aurora impide aplicar fuera de staging/prod.
