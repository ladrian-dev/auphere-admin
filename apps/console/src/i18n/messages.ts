...
const core = {
  ...
  "clients.detail.missing.quota": { es: "cupo", en: "quota" },
  "clients.health.outOfQuota": { es: "Sin cupo: sus mensajes no se atienden. Asígnale créditos en Consumo.", en: "Out of quota: its messages are not answered. Assign it credits in Usage." },
  ...
  "clients.health.fix.quota": { es: "Asignar cupo", en: "Assign quota" },
  ...
  "clients.pause.title": { es: "Suspender {name}", en: "Suspend {name}" },
  ...
  "agent.rollback.body": { es: "Los próximos mensajes los atenderá la versión {v}. La {active} se queda en el historial: puedes volver a ella cuando quieras.", en: "Upcoming messages will be handled by version {v}. Version {active} stays in the history; you can return to it any time." },
