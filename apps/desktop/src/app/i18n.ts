...
const COPY = {
  ...
  "shell.search.looking": { es: "Buscando en lo hablado…", en: "Searching what was said…" },
  "shell.command.conversation": { es: "Conversaciones", en: "Conversations" },
  "today.start.placeholder": { es: "¿Qué necesitas? (Enter envía)", en: "What do you need? (Enter sends)" },
  "today.start.send": { es: "Empezar", en: "Start" },
  "today.start.with": { es: "Se lo pides a", en: "You are asking" },
  "conv.new": { es: "Nueva conversación", en: "New conversation" },
  "conv.pick": { es: "Conversación", en: "Conversation" },
  "conv.untitled": { es: "Sin título todavía", en: "Untitled yet" },
  "conv.elsewhere": { es: "Hay trabajo en marcha en «{title}».", en: "There is work running in \u201c{title}\u201d." },
