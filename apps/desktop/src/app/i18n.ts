...
const COPY = {
  ...
  "workstation.action.emparejar": { es: "Emparejar esta máquina", en: "Pair this machine" },
  ...
  "workstation.action.volver_a_la_app": { es: "Volver al equipo", en: "Back to your team" },
