...
ALL_EXPECTED = {
    ...
    "expire-credit-cron",
    # Spec 006: barre las solicitudes de alta que nadie llegó a usar. Va aquí
    # ADEMÁS de en ``bootstrap``, y ese "además" es lo que se olvidó las dos
    # veces que se abortó un despliegue.
    "expire-signups-cron",
